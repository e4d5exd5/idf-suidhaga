                        ...
                        {(() => {
                            if (next) {
                                return (
                                    <>
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.mobile && formik.touched.mobile
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.password && formik.touched.password
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.cpassword && formik.touched.cpassword
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                ...
                                return (
                                    <>
                                        {/* Title */}
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.title && formik.touched.title
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        {/* First Name */}
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.f_name && formik.touched.f_name
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        {/* Middle Name */}
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.m_name && formik.touched.m_name
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        {/* Last Name */}
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.l_name && formik.touched.l_name
                                                    ? 'border-rose-600'
                                                    : ''
                                                }`}
                                        >
                                        ...
                                        {/* Aadhar Number */}
                                        <div
                                            className={`flex border rounded-xl relative ${formik.errors.aadharNumber && formik.touched.aadharNumber
                                                ? 'border-rose-600'
                                                : ''
                                                }`}
                                        >
                                        ...
                                        {formik.errors.aadharNumber && formik.touched.aadharNumber ? (
                                            <span className='text-rose-500'>{formik.errors.aadharNumber}</span>
                                        ) : (
                                            <></>
                                        )}
                                    </>
